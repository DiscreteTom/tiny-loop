...
- `#[tool]` macro now derives `Serialize`, `Clone`, and `Debug` for generated ToolArgs structs
...
[Unreleased]: https://github.com/DiscreteTom/tiny-loop/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/DiscreteTom/tiny-loop/releases/tag/v0.4.1...v0.5.0
